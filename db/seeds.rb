...
Caregiver.create(:id => 1, :email => 'caregiver1@email1.com', :name => 'Kali Burns', :image_url => '/images/demo/caregiver-1.jpg', 
...
Caregiver.create(:id => 2, :email => 'caregiver2@email2.com', :name => 'Jessie McFadden', :image_url => '/images/demo/caregiver-2.jpg',
	:gender => 1, :language => '', :city => 'Des Moines', :state => 'IA', :zip => '50301',
	:description => 'Hi my name is Jess.  I enjoy helping people help themselves.  I view myself as a motivating, positive person.  One of my greatest skills is&#39;',
	:age => 39, :years_of_experience => 15, :occupation => 'Homemaker/Companion', :insured => true, :bonded => true, :reviewed => true)
	
Caregiver.create(:id => 3, :email => 'caregiver3@email3.com', :name => 'Robert Somerson', :image_url => '/images/demo/caregiver-3.jpg',
